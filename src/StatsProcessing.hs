...
buildTweetText w cl n = "The " ++ language w ++ " edition of Wikipedia " ++ (fromMaybe (\_ -> "") $ Map.lookup cl statDescriptions) (formatStat n) ++ "! Enjoy more stats here: https://" ++ subdomain w ++ ".wikipedia.org/wiki/Special:Statistics"
